    ...
    <div>
        <div>
            <v-data-table :headers="headers" :items="indexSn" class="elevation-1">
                <template v-slot:top>
                    <v-toolbar flat>
                        <v-toolbar-title>My Loan</v-toolbar-title>
                        ...
                        <v-dialog v-model="dialog" max-width="500px">
                            ...
                            <v-card>
                                <div class="title pt-4">
                                    <span class="text-h6">Apply for Loan </span>
                                </div>
                                ...
                                <v-card-text>
                                    <v-container>
                                        <v-row>
                                            ...
                                            <v-col cols="12">
                                                <b-button v-b-modal.modal-multi-1 style="background: #20618c; color: #fff; width: 100%" @click="save" size="lg">Apply</b-button>
                                            </v-col>
...
async find(){
    try{
   const response = await this.$http.get('/list-my-loan', )
       ...
       async save() {
            if (!this.editedItem.loan_amount ) {
              ...
              //  console.log(this.institution_name, this.institution_code, "=-------------")
                const response = await this.$http.post('/apply-loan', {
